...
echo "#[fg=$COLOR_BG_DARK,bg=$COLOR_GREEN]#[fg=$COLOR_BG_DARK,bg=$COLOR_GREEN] Target #[fg=$COLOR_GREEN,bg=$COLOR_BG_DARK]#[fg=$COLOR_BG_DARK,bg=$COLOR_BG_BLUE]#[fg=$COLOR_YELLOW]$IP#[fg=$COLOR_BG_BLUE,bg=$COLOR_BG_DARK]#[fg=$COLOR_BG_DARK,bg=$COLOR_BG_BLUE]#[fg=$COLOR_GREEN,bg=$COLOR_BG_BLUE] #[fg=$COLOR_YELLOW]#[fg=$COLOR_PURPLE]$NAME "
